    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(hr, file, 60, 1, 1010);
    			attr_dev(h1, "class", "svelte-q602it");
    			add_location(h1, file, 62, 2, 1063);
    			add_location(p, file, 63, 2, 1093);
    			add_location(button0, file, 65, 2, 1110);
    			add_location(button1, file, 67, 2, 1200);
    			attr_dev(div, "class", "stuff svelte-q602it");
    			add_location(div, file, 61, 1, 1016);
    			attr_dev(main, "class", "svelte-q602it");
    			add_location(main, file, 59, 0, 1002);
    		},
